...
<script src="includes/scripts.js?1"></script>
    ...
    <div id="result" class="module">
        ...
        <div id="tab-options" class="history">
            <h4>
                ...
                <input class="btn btn-default btn-sm" type="button" value="save" onclick="setOption('detectdeauth_alert_delay', 'mod_detectdeauth_alert_delay');">
                <br><br>
                Number (deauth events)
                <br>
            ...
            <h4>
                ...
                <input class="btn btn-default btn-sm" type="button" value="save" onclick="setOption('detectdeauth_smtp_server', 'mod_detectdeauth_smtp_server'); setOption('detectdeauth_smtp_port', 'mod_detectdeauth_smtp_port'); ">
                
                <br><br>
                
                <div style="width: 50px; display: inline-block">User</div> <input id="detectdeauth_smtp_user" class="form-control input-sm" placeholder="User" value="<?=$mod_detectdeauth_smtp_user?>" style="width: 180px; display: inline-block; " type="text" />
                <br>
                <div style="width: 50px; display: inline-block">Pass</div> <input type="password" id="detectdeauth_smtp_pass" class="form-control input-sm" placeholder="Port" value="<?=$mod_detectdeauth_smtp_pass?>" style="width: 180px; display: inline-block; " type="text" />
                <input class="btn btn-default btn-sm" type="button" value="save" onclick="setOption('detectdeauth_smtp_user', 'mod_detectdeauth_smtp_user'); setOption('detectdeauth_smtp_pass', 'mod_detectdeauth_smtp_pass'); ">
                <br>
            ...
            <h4>
                ...
                <div id="channel">
                    <!--<label></label>
                    <br>-->
                    <? $a_channel = explode(",", $mod_detectdeauth_channel); ?>
...
<script>
    $('.btn-default').on('click', function(){
        ...
        $.getJSON('../api/includes/ws_action.php?api=/config/module/detectdeauth/'+param+'/'+value, function(data) {});
    }); 
</script>
